...
<img src = {theme === 'dark' ? assets.logo_dark: assets.logo} className='w-32 sm:w-40' alt = 'logo'/>
    <div className='dark:text-white sm:text-sm flex flex-row items-center justify-center gap-6 text-gray-700 transition-all max-sm:hidden'>
            <a href="#" className='hover:text-primary transition-colors'>Home</a>
            <a href="#services" className='hover:text-primary transition-colors'>Services</a>
            <a href="#OurWork" className='hover:text-primary transition-colors'>Our Work</a>
